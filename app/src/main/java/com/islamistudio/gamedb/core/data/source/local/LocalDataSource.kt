package com.islamistudio.gamedb.core.data.source.local

import com.islamistudio.gamedb.core.data.source.local.entity.GameEntity
import com.islamistudio.gamedb.core.data.source.local.room.GameDao
...
class LocalDataSource(private val gameDao: GameDao) {
    ...
    fun setFavoriteGame(game: GameEntity, newState: Boolean) {
        ...
        gameDao.updateGameFavorite(game)
    }
